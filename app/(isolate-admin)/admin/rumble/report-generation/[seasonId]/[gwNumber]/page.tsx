    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="border rounded p-4">
          ...
          {clubPieUrl ? <img src={clubPieUrl} alt="Picks by Club" className="w-full h-auto" /> : <p>No data.</p>}
        </div>

        <div className="border rounded p-4">
          <h2 className="font-medium mb-2">Manual vs Proxy</h2>
          {sourcePieUrl ? <img src={sourcePieUrl} alt="Manual vs Proxy" className="w-full h-auto" /> : <p>No data.</p>}
        </div>
      </div>

      <div className="border rounded p-4">
        <h2 className="font-medium mb-2">Eliminations</h2>
        {svgDataUrl ? <img src={svgDataUrl} alt="Eliminations" className="max-w-full h-auto" /> : <p>Not available until this GW is graded.</p>}
      </div>
    </div>
  );
}
