...
async function fetchNextGw(): Promise<NextGw | null> {
  ...
  // Try lowercase Prisma client name first (typical), then fallbacks safely.
...
export default async function Home() {
  ...
  // run both in parallel; both are optional and fully guarded
      ...
      <div className="mt-10">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Tile
            href="/rumble/reports"
            title="Reports"
            desc="Browse public gameweek reports."
            emoji="📊"
          />
